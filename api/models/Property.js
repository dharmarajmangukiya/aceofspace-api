module.exports = {
  ...
  attributes: {
    ...
    balconies: { type: 'string', allowNull: true },
    ...
    maintenance: { type: 'string', defaultsTo: 'monthly', isIn: ['monthly', 'quarterly', 'yearly'] },
    priceNegotiation: { type: 'boolean', defaultsTo: false },
    bookingAmount: { type: 'number', allowNull: true },
    membershipCharge: { type: 'boolean', defaultsTo: false },
